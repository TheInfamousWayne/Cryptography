...
class GUI(Frame):
    ...
    def update_lists(self, type=None, id=None, price=None, vol=None):
        if type:
            if type == 1:
            ...
            ################################################
        self.root.after(UPDATE_RATE, self.update_lists, None, None, None, None)
    ...
    def start(self):
        ...
        self.create_window()
        self.update_lists(None, None, None, None)
        self.root.mainloop()
